...
//    }
    ...
    /**
     * ALM Testcase: Res_Avis_US_EN_005_Reservation_Domestic_PayNow
     */
//    @Test(groups = {REGRESSION,SMOKE},priority=2, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    // public void Budget_Reservation_ErrorMessage_PayNow_US_EN(String pickUpLocation, String firstName, String lastName, String email,
   ...
   @Test(groups = {REGRESSION,SMOKE},priority=3, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_CCOLocation_PayLater_US_EN(String pickUpLocation, String firstName, String lastName, String email,
   ...
   @Test(groups = {REGRESSION,SMOKE},priority=4, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_Costco_PayLater_US_EN(String pickUpLocation, String awd, String membershipNo, String fname,
   ...
   @Test(groups = {REGRESSION, SANITY,SMOKE},priority=5, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_EMEA90Days_ErrorMessage_US_EN(String pickUpLocation, String months) {
        launchUrl();
       Homepage homePage = new Homepage(getDriver());
       homePage.findAndCloseAdOverLay();
   ...
   @Test(groups = {REGRESSION, SANITY, SMOKE},priority=6, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_EMEA330Days_ErrorMessage_US_EN(String pickUpLocation, String months) {
        launchUrl();
        Homepage homePage = new Homepage(getDriver());
        homePage.findAndCloseAdOverLay();
        ReservationWidget reservationWidget = new ReservationWidget(getDriver());
   ...
   @Test(groups = {REGRESSION, SANITY,SMOKE},priority=7, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_OneClick_Step3_US_EN(String url) {
        launchUrl();
        Homepage homepage = new Homepage(getDriver());
   ...
   // @Test(groups = {REGRESSION, SANITY,SMOKE},priority=8, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_OneClick_GPSSelection_US_EN(String url) {
        launchUrl();
        Homepage homepage = new Homepage(getDriver());
        homepage.oneClickLandingPage(url);
        ReviewAndBook reviewAndBook = new ReviewAndBook(getDriver());
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=9, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_GEBUser_PayLater_US_EN(String pickUpLocation, String wizardNo, String lastName, String firstName,
   ...
   @Test(groups = {REGRESSION, SANITY,SMOKE},priority=10, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_GtypeCouponProcessing_PayLater_US_EN(String pickUpLocation, String couponNo, String fname,
                                                           String lname, String email, String phoneNo) {
...
//       assertEquals(map.get("errorColor"),"rgba(212, 0, 42, 1)", "CouponError Color is different than expected");
   ...
   @Test(groups = {REGRESSION, SANITY, SMOKE},priority=11, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_UtypeCouponProcessing_PayLater_US_EN(String pickUpLocation, String couponNo, String fname,
                                                           String lname, String email, String phoneNo) {
    ...
    public void Budget_Reservation_MtypeCouponProcessing_PayLater_US_EN(String pickUpLocation, String couponNo, String fname,
                                                           String lname, String email, String phoneNo) {
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=13, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_Inbound_PayLater_US_EN(String pickUpLocation, String Country, String firstName, String lastName,
   ...
   @Test(groups = {REGRESSION,SMOKE},priority=14, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_Inbound_PayNow_US_EN(String pickUpLocation, String Country, String firstName, String lastName,
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=15, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_US_ENAA_PayLater_US_EN(String pickUpLocation, String awd, String membershipNo, String fname,
                                          String lname, String email, String phoneNo) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
        Confirmation confirmation = reservationHelper.Reservation_Costco_USAA_PayLater(pickUpLocation, awd, membershipNo, fname, lname, email, phoneNo);
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=16, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_SnowChain_PayLater_US_EN(String pickUpLocation, String firstName, String lastName, String email,
                                               String phoneNo) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=17, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_Recognised_Paylater_US_EN(String pickUpLocation, String wizardNo, String lastName,
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=18, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_OutboundAndMultiCurrency_Paylater_US_EN(String pickUpLocation,String residencyLocation, String firstName, String lastName,
   ...
   @Test(groups = {REGRESSION, SMOKE},priority=19, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_OneWay_PayLater_US_EN(String pickUpLoction, String dropOffLocation, String fname, String lname,
                                            String email, String phoneNo) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
    ...
    public void Budget_Reservation_TierBundle_PayLater_US_EN(String pickUpLocation, String firstName, String lastName, String email,
                                                String phoneNo, String ccNo, String cvv) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
...
//        confirmation.closeGetFreeCouponPopup().cancelReservation();
   ...
   @Test(groups = {REGRESSION, SANITY,SMOKE},priority=21, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_UnderAgeAndHomePageErrorMessageAndPersonalInfoValidation_Paylater_US_EN(String pickUpLocation,
...
//    @Test(groups = {REGRESSION, SANITY,SMOKE},priority=22, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_FTPPayLater_Authenticated_US_EN(String wizardNo, String password, String pickUpLocation,
...
//    @Test(groups = {REGRESSION, SANITY,SMOKE},priority=23, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_AuthenticatedAndDomestic_Paylater_US_EN(String pickUpLocation, String wizardNo, String password,
                                                              String pickUpLocation1) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
...
//    @Test(groups = {REGRESSION, SANITY, SMOKE},priority=24, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_SMSOptInProfile_Verification_US_EN(String wizardNo, String password, String pickUpLocation,
                                                         String phoneNo) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
...
//    @Test(groups = {REGRESSION, SANITY, SMOKE},priority=25, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_LastMinuteBundle_PayLater_US_EN(String pickUpLocation, String firstName, String LastName,
                                                      String email, String phoneNo) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
   ...
   @Test(groups = {REGRESSION, SANITY, SMOKE},priority=26, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Budget_Reservation_AnonymousDomesticAWDorBDCorPDNAndIATAAndKeyDrop_Paylater_US_EN(String pickUpLocation,
    ...
    public void Budget_Reservation_MandateflightInfoAndTtypeCouponProcessingStrikeThrough_Paylater_US_EN(String pickUpLocation,
