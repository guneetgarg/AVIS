...
public class AvisCAAnonymousUser extends TestBase {
    ...
    public void Avis_RES_FlightInfo_DigitalWallet_PayPal_PayNow_CA(String pickUpLocation, String fname, String lname,
...
//
//    @Test(groups = {REGRESSION, SANITY,SMOKE, AVIS}, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
//    public void Avis_Misc_OffersPage_SignUp_CA(String email, String firstName, String lastName, String country) {
//        launchUrl();
