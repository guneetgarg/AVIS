...
import static com.avis.qa.constants.TextComparison.CONFIRMATION_NUMBER_NOT_DISPLAYED_MESSAGE;
import static com.avis.qa.constants.TextComparison.CURRENCY_VALUE_INCORRECT_MESSAGE;
 ...
 */
@Log4j2
public class AvisNZAnonymousUser extends TestBase {

    @Test(groups = {REGRESSION, SMOKE,AVIS}, priority = 18, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Avis_Reservation_OutboundAndMultiCurrency_Paylater_NZ(String pickUpLocation, String residencyLocation, String firstName, String lastName,
    ...
    public void Avis_RES_Inbound_Domestic_MultiCurrency_PayLater_NZ(String pickUpLocation, String residencyLocation, String firstName, String lastName,
    ...
    public void Avis_RES_Outbound_CorpCust_insuranceCover_Validate_CorpBooking_Paynow_NZ(String pickUpLocation, String pickupTime, String awd, String corporateEmailId, String firstName, String lastName,
    ...
    public void Avis_RES_Modify_flow_Step1_to_step4_NZ(String pickUpLocation, String firstName, String lastName,
    ...
    public void Avis_RES_AWD_SplitBillItemized_CorpCust_insuranceCover_Validate_CorpBooking_Paylater_NZ(String pickUpLoction, String AWD, String corporateEmailId, String fname, String lname,
    ...
    public void Avis_RES_G_typeCoupon_LocMandate_FlightInfo_SMSCheckbox_IATA_PayLater_NZ(String pickUpLocation, String couponNo, String fname,
    ...
    public void Avis_RES_Outbound_StrikeThroughCoupon_Cancelation_PayLater_NZ(String pickUpLocation, String residencyLocation, String awd, String fname, String lname,
    ...
    public void Avis_Reservation_ErrorMessage_PayNow_NZ(String pickUpLocation, String firstName, String lastName, String email,
    ...
    public void Avis_Location_Search_MnemonicCodeRes_NZ(String pickUpLocation, String firstName, String lastName, String email,
                                                        String phoneNo) {
        launchUrl();
    ...
    public void Avis_RES_EMEA90Days_ErrorMessage_Step1_Res_widget_NZ(String pickUpLocation, String months) {
        launchUrl();
    ...
    public void Avis_RES_Misc_Verify_Underage_onStep1_FleetFliter_VehicleType_Seats_Mileage_Price_onStep2_NZ(String pickUpLocation, String age)  {
        launchUrl();
        ReservationWidget reservationWidget = new ReservationWidget(getDriver());
    ...
    public void Avis_Reservation_USAA_PayLater_NZ(String pickUpLocation, String awd, String membershipNo, String fname,
    ...
    @Test(groups = {REGRESSION, SANITY, SMOKE, AVIS}, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Avis_Misc1_OffersPage_Reservation_NZ(String pickUpLoction, String dropOffLocation, String fname, String lname,
    ...
    public void Avis_Location_Browse_Category_NZ(String test) {
        launchUrl();
    ...
    public void Avis_Reservation_OneWay_PayLater_NZ(String pickUpLoction, String dropOffLocation, String fname, String lname,
                                                    String email, String phoneNo) {
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
        Confirmation confirmation = reservationHelper.Reservation_OneWay_PayLater(pickUpLoction, dropOffLocation, fname, lname, email, phoneNo);
    ...
    public void Avis_Reservation_TierBundle_PayLater_NZ(String pickUpLocation, String firstName, String lastName, String email,
    ...
    @Test(groups = {REGRESSION, SMOKE, AVIS}, priority = 1, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Avis_Reservation_Outbound_PayNow_NZ(String pickUpLocation, String firstName, String lastName, String email, String phoneNumber, String ccNumber, String cvv) {
        launchUrl();
        Homepage homePage = new Homepage(getDriver());
    ...
    public void Avis_Misc_CarGuide_Res_NZ(String pickUpLoc, String firstName, String lastName, String email, String phoneNo) {
        launchUrl();
    ...
    public void Avis_Misc_OffersPage_Reservation_NZ(String pickUplocation, String firstName, String lastName, String email,
                                                    String phoneNo) {
        launchUrl();
        MiscHelper miscHelper = new MiscHelper(getDriver());
    ...
    @Test(groups = {REGRESSION, SANITY,SMOKE,AVIS}, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Avis_Misc_OneClick_VanityURL_NZ(String url, String title) {
    ...
    public void Avis_Reservation_CCOLocation_PayLater_NZ(String pickUpLocation, String firstName, String lastName, String email,
                                                         String phoneNo, String cCNumber) {
        log.info("Test case execution started :Avis_Reservation_CCOLocation_PayLater_NZ");
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
        ...
        log.info("Test case execution ended :Avis_Reservation_CCOLocation_PayLater_NZ");
    }

    @Test(groups = {REGRESSION, SMOKE,AVIS, TEST}, priority = 4, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Avis_Reservation_Costco_PayLater_NZ(String pickUpLocation, String awd, String membershipNo, String fname,
                                                    String lname, String email, String phoneNo) {
        log.info("Test case execution started :Avis_Reservation_Costco_PayLater_NZ");
        launchUrl();
        ReservationHelper reservationHelper = new ReservationHelper(getDriver());
        Confirmation confirmation = reservationHelper.Reservation_Costco_USAA_PayLater(pickUpLocation, awd, membershipNo, fname, lname, email, phoneNo);
        assertTrue(confirmation.isAwdConfirmationPageTextDisplayed(awd), "AWD Confirmation text is not displayed");
        assertTrue(confirmation.isConfirmationNumberDisplayed(), "Confirmation Number is not displayed");
        confirmation.cancelReservation();
        log.info("Test case execution ended :Avis_Reservation_Costco_PayLater_NZ");
    }

    @Test(groups = {REGRESSION, SANITY, SMOKE,AVIS}, priority = 5, dataProvider = TEST_DATA, dataProviderClass = CSVUtils.class)
    public void Avis_Reservation_EMEA90Days_ErrorMessage_NZ(String pickUpLocation, String months) {
        launchUrl();
        ReservationWidget reservationWidget = new ReservationWidget(getDriver());
        reservationWidget
                .pickUpLocation(pickUpLocation)
    ...
    public void Avis_Reservation_EMEA330Days_ErrorMessage_NZ(String pickUpLocation, String months) {
        launchUrl();
        ReservationWidget reservationWidget = new ReservationWidget(getDriver());
