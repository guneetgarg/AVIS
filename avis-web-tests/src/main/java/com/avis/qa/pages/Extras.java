...
public class Extras extends AbstractBasePage {
    ...
    @FindBy(xpath = "//span[contains(text(),'Your provided AWD number includes discounts or certain extras, and may include')] | //span[contains(text(),'Your provided AWD number includes or discounts certain extras, and may include ')]")
