...
public class TextComparison {
    ...
    public static final String RESERVATION_CONFIRMATION_MESSAGE_DISPLAYED_STATUS = "Confirmation Message not displayed";
    public static final String COUPON_CODE_NOT_DISPLAYED_MESSAGE = "Coupon Code is not displayed";
    public static final String NO_CARS_AVAILABLE_MESSAGE = "No cars available message is not displayed";
    public static final String LOCATION_CLOSED_MESSAGE = "Location close message not displayed";
    public static final String UNDER_SUB_AGE_MESSAGE = "Under Age Sub charge Message Not displayed";
    public static final String RESERVATION_CANCELLATION_MESSAGE = "Cancellation Message not displayed";
